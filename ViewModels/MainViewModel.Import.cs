    ...
    public partial class MainViewModel
    {
        ...
        private async Task ImportFolderCoreAsync(CancellationToken operationToken)
        {
            try
            {
                ...
                // Value = true  → merge into existing destination folder
                //         false → plain copy (destination does not exist yet,
                //                 or user chose Skip — handled separately)
                ...
                {
                    StatusMessage = "Import skipped — all folders were skipped.";
                    return;
                }
